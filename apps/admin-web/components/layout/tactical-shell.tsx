...
const NAV_ITEMS = [
  { href: '/dashboard', label: 'Centro de Mando' },
  { href: '/dashboard/academia', label: 'SITOP Academia' },
];
        ...
        <div className="border-t border-slate-800 p-4">
          {session && (
            <div className="mb-3 rounded-lg bg-slate-950/60 px-3 py-2">
              ...
              <p className="truncate text-xs text-cyan-400/90">
                {session.rangeRole.replace(/_/g, ' ')}
              </p>
            </div>
          )}
          <button
